 ...
 */
public class MySQLAuthenticationException extends AuthenticationException
{
    /**
     ...
     */
    public MySQLAuthenticationException(String msg, Throwable t)
    {
        super(msg, t);
    }
     ...
     * @param msg   The error message for the exception
     */
    public MySQLAuthenticationException(String msg)
    {
        super(msg);
    }
}
